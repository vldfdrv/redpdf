...
#
# Description : Example 038 for RBPDF class
...
class Example038Controller < ApplicationController
  def index
    ...
    pdf.set_title('RBPDF Example 038')
    pdf.set_subject('RBPDF Tutorial')
    pdf.set_keywords('RBPDF, PDF, example, test, guide')
    
    # set default header data
    pdf.set_header_data(PDF_HEADER_LOGO, PDF_HEADER_LOGO_WIDTH, PDF_HEADER_TITLE + ' 038', PDF_HEADER_STRING)
